...
class NewsSourceController extends BackEndController
{
	...
	public function actionCreate()
	{
		...
		{
                    $model->attributes=$_POST['NewsSource'];
	...
	public function actionIndex()
		...
		$dataProvider=new CActiveDataProvider('NewsSource');
	...
	{
		$model=new NewsSource('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['NewsSource']))
			$model->attributes=$_GET['NewsSource'];
	...
	{
		$model=NewsSource::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param NewsSource $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='news-source-form')
		{
