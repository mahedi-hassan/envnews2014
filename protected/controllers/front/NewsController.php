...
class NewsController extends Controller {
    ...
    /**
     * Manages all models categorywise.
     */
    public function actionCategory($id) {
        $criteria = new CDbCriteria(array(
            'order' => 'published_date DESC, id DESC',
            'condition' => 'cat_id IN(SELECT id FROM {{news_category}} WHERE id=' . $id . ' OR parent_id=' . $id . ') AND state = 1',
                //'condition' => 'cat_id =' . $id . ' AND state = 1',
        ));
    ...
    /**
     * Manages all news source wise
     */
    public function actionSource($id) {
        $criteria = new CDbCriteria(array(
            'order' => 'published_date DESC, id DESC',
            'condition' => 'sorc_id=' . $id . ' AND state = 1',
            'limit' => '500',
        ));
        $dataProvider = new CActiveDataProvider('News', array(
            'criteria' => $criteria,
