...
$this->heading = '<i class="fa fa-archive"></i> Manage Reports';
...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'type' => 'raw',
            'header' => 'title',
            'value' => 'CHtml::link(CHtml::encode($data->title), array("/report/view","id"=>$data->id))',
            'htmlOptions' => array('style' => "text-align:left;", 'title' => 'Title'),
        ),
        array(
            'name' => 'reporter',
            'type' => 'raw',
            'value' => 'CHtml::encode($data->reporter)',
            'htmlOptions' => array('style' => "text-align:left;", 'title' => 'Title'),
        ),
        array(
            'name' => 'published_by',
            'type' => 'raw',
            'value' => 'CHtml::encode($data->published_by)',
            'htmlOptions' => array('style' => "text-align:left;", 'title' => 'Title'),
        ),
        'published_time',
        array(
