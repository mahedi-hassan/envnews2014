...
$assetsDir = dirname(__FILE__) . '/../uploads/books';
...
$this->heading = '<i class="fa fa-archive"></i> Manage Books';
...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'name' => 'cover_image',
            'type' => 'html',
            'value' => 'CHtml::image(Yii::app()->baseUrl . "/uploads/books/" . $data->cover_image, "Cover Image", array("class" => "span12 thumbnail", "style" => ""))',
        ...
        array(
            ...
            'type' => 'raw',
            'header' => 'Title',
            'value' => 'CHtml::link(CHtml::encode($data->title), array("/book/view","id"=>$data->id))',
