...
<div class="form">
    ...
    <div class="well span4">
        ...
        <?php } else { ?>
            <?php echo CHtml::image(Yii::app()->baseUrl . '/uploads/books/' . $model->cover_image, 'News Image', array('alt' => $model->title, 'class' => 'span4 thumbnail pull-right', 'title' => $model->title, 'style' => 'margin:0px 10px 10px 0px;')); ?>
            <?php echo $form->fileFieldControlGroup($model, 'cover_image', array('class' => 'span4')); ?>
        <?php } ?>
    </div>
    <br />
    ...
    <?php echo $form->textFieldControlGroup($model, 'price', array('span' => 5, 'maxlength' => 50)); ?>

    <?php echo $form->textFieldControlGroup($model, 'pages', array('span' => 5, 'maxlength' => 50)); ?>
