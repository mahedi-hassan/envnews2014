...
$this->heading = '<i class="fa fa-edit"></i> View Book';
?>
...
$this->widget('zii.widgets.CDetailView', array(
    ...
    'attributes' => array(
        ...
        array(
            'name' => 'cover_image',
            'type' => 'raw',
            'value' => CHtml::image(Yii::app()->baseUrl . '/uploads/books/' . $model->cover_image, 'News Image', array('alt' => $model->title, 'class' => 'span4 thumbnail', 'title' => $model->title, 'style' => 'margin:0px 10px 10px 0px;')),
        ),
        'description',
        'writter',
        'publication',
